...
public class ClayiumBlockModelProvider extends BlockStateProvider {
    ...
    private static final ResourceLocation ENERGETIC_CLAY_CONDENSER_TEXTURE = Clayium
            .id("block/machine/energetic_clay_condenser");
    ...
    private static final ResourceLocation CHEMICAL_METAL_SEPARATOR_TEXTURE = Clayium
            .id("block/machine/chemical_metal_separator");
    ...
    private static final ResourceLocation CA_REACTOR_CORE_TEXTURE_UNFORMED = Clayium
            .id("block/machine/ca_reactor_core_unformed");
    private static final ResourceLocation CA_REACTOR_CORE_TEXTURE_FORMED = Clayium
            .id("block/machine/ca_reactor_core_formed");
    ...
    protected void registerStatesAndModels() {
        ...
        ModelFile craftingBoardModel = models().getExistingFile(Clayium.id("block/clay_crafting_board"));
        simpleBlock(ClayiumBlocks.CLAY_CRAFTING_BOARD.get(), craftingBoardModel);
        ...
        for (var entry : ClayiumBlocks.ENERGETIC_CLAY_CONDENSER_BLOCKS.int2ObjectEntrySet()) {
            registerSingleMachine(entry.getValue().get(), entry.getIntKey(), ENERGETIC_CLAY_CONDENSER_TEXTURE);
        }
        ...
        registerSingleMachine(ClayiumBlocks.CHEMICAL_METAL_SEPARATOR.get(), 6,
                CHEMICAL_METAL_SEPARATOR_TEXTURE);
        ...
        for (var entry : ClayiumBlocks.CA_REACTOR_CORE_BLOCKS.int2ObjectEntrySet()) {
            registerSingleMachine(entry.getValue().get(), entry.getIntKey(), CA_REACTOR_CORE_TEXTURE_UNFORMED,
                    Map.of(AbstractMultiblockMachineBlockEntity.FRONT_OVERLAY_VARIANT_FORMED,
                            CA_REACTOR_CORE_TEXTURE_FORMED),
                    false, false);
        }
        for (var entry : ClayiumBlocks.CA_REACTOR_COILS.values()) {
            simpleBlockAndItem(entry.get());
        }
        for (var entry : ClayiumBlocks.CA_REACTOR_HULLS.values()) {
            simpleBlockAndItem(entry.get());
        }
