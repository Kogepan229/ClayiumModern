...
public class XEIMachineRecipeCategory {
    ...
    public static List<XEIMachineRecipeCategory> getCategories() {
        ...
        categories.add(new XEIMachineRecipeCategory(ClayiumRecipeTypes.ELECTROLYSIS_REACTOR_RECIPE_TYPE,
        ...
        categories.add(new XEIMachineRecipeCategory(ClayiumRecipeTypes.ALLOY_SMELTER_RECIPE_TYPE,
        ...
        categories.add(new XEIMachineRecipeCategory(ClayiumRecipeTypes.CA_CONDENSER_RECIPE_TYPE,
                ClayiumBlocks.CA_CONDENSER_BLOCKS.values()));
        categories.add(new XEIMachineRecipeCategory(ClayiumRecipeTypes.MATTER_TRANSFORMER_RECIPE_TYPE,
                ClayiumBlocks.MATTER_TRANSFORMER_BLOCKS.values()));
