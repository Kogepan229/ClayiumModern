...
/**
 * Filter item: list of items; match by same item type only (ignores NBT/damage). Plan A.
 */
public class FazyItemFilterItem extends ItemFilterBase {

    public static final int FILTER_SIZE_X = 5;
    public static final int FILTER_SIZE_Y = 2;
    public static final int SLOT_COUNT = FILTER_SIZE_X * FILTER_SIZE_Y;

    public FazyItemFilterItem() {
        super();
    }
