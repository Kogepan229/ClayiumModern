...
public class AutoEatGadgetItem extends ClayGadgetItem implements HeldItemUIMenuType.HeldItemUI {

    public AutoEatGadgetItem(Properties properties, int tier, @NotNull IClayGadget gadget) {
        super(properties, tier, gadget);
    }
    ...
    public ModularUI createUI(HeldItemUIMenuType.HeldItemUIHolder holder) {
        ...
        for (int row = 0; row < 2; row++) {
            ...
            for (int column = 0; column < 5; column++) {
                slotRow.addChild(PhantomItemSlot.create(handler, row * 5 + column));
            }
        }
        root.addChild(slots);
    ...
    public void appendHoverText(@NotNull ItemStack stack, @NotNull TooltipContext context,
        ...
        tooltipComponents.add(Component.translatable("tooltip.clayium.gadget_auto_eat_filter"));
