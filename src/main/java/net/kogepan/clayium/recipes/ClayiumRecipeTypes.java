...
public class ClayiumRecipeTypes {
    ...
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> SMELTER_RECIPE_TYPE = registerSimpleMachineType(
            "smelter", 1, 1);
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> ALLOY_SMELTER_RECIPE_TYPE = registerSimpleMachineType(
            "alloy_smelter", 2, 1);
    ...
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> INSCRIBER_RECIPE_TYPE = registerSimpleMachineType(
            "inscriber", 2, 1);
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> ASSEMBLER_RECIPE_TYPE = registerSimpleMachineType(
            "assembler", 2, 1);
    ...
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> CA_CONDENSER_RECIPE_TYPE = registerSimpleMachineType(
            "ca_condenser", 1, 1);
    public static final DeferredHolder<RecipeType<?>, SimpleMachineRecipeType<MachineRecipe>> MATTER_TRANSFORMER_RECIPE_TYPE = registerSimpleMachineType(
            "matter_transformer", 1, 1);
}
