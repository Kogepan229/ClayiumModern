...
public class ClayiumItems {
    ...
    public static final DeferredItem<Item> MAGNESIUM_DUST = ITEMS.registerItem("magnesium_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> SODIUM_DUST = ITEMS.registerItem("sodium_dust", p -> new TieredItem(p, 6));
    ...
    public static final DeferredItem<Item> ZINC_DUST = ITEMS.registerItem("zinc_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> MANGANESE_DUST = ITEMS.registerItem("manganese_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> POTASSIUM_DUST = ITEMS.registerItem("potassium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> HAFNIUM_DUST = ITEMS.registerItem("hafnium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> STRONTIUM_DUST = ITEMS.registerItem("strontium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> BARIUM_DUST = ITEMS.registerItem("barium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> CALCIUM_DUST = ITEMS.registerItem("calcium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IRON_DUST = ITEMS.registerItem("iron_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> LEAD_DUST = ITEMS.registerItem("lead_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> COPPER_DUST = ITEMS.registerItem("copper_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> NICKEL_DUST = ITEMS.registerItem("nickel_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> BERYLLIUM_DUST = ITEMS.registerItem("beryllium_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> CHROME_DUST = ITEMS.registerItem("chrome_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> TITANIUM_DUST = ITEMS.registerItem("titanium_dust", p -> new TieredItem(p, 9));
    ...
    public static final DeferredItem<Item> IMPURE_MAGNESIUM_DUST = ITEMS.registerItem("impure_magnesium_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> IMPURE_SODIUM_DUST = ITEMS.registerItem("impure_sodium_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> IMPURE_LITHIUM_DUST = ITEMS.registerItem("impure_lithium_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> IMPURE_ZIRCONIUM_DUST = ITEMS.registerItem("impure_zirconium_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> IMPURE_ZINC_DUST = ITEMS.registerItem("impure_zinc_dust", p -> new TieredItem(p, 6));
    public static final DeferredItem<Item> IMPURE_MANGANESE_DUST = ITEMS.registerItem("impure_manganese_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_POTASSIUM_DUST = ITEMS.registerItem("impure_potassium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_HAFNIUM_DUST = ITEMS.registerItem("impure_hafnium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_STRONTIUM_DUST = ITEMS.registerItem("impure_strontium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_BARIUM_DUST = ITEMS.registerItem("impure_barium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_CALCIUM_DUST = ITEMS.registerItem("impure_calcium_dust", p -> new TieredItem(p, 7));
    public static final DeferredItem<Item> IMPURE_IRON_DUST = ITEMS.registerItem("impure_iron_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> IMPURE_LEAD_DUST = ITEMS.registerItem("impure_lead_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> IMPURE_COPPER_DUST = ITEMS.registerItem("impure_copper_dust", p -> new TieredItem(p, 8));
    public static final DeferredItem<Item> IMPURE_NICKEL_DUST = ITEMS.registerItem("impure_nickel_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> IMPURE_BERYLLIUM_DUST = ITEMS.registerItem("impure_beryllium_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> IMPURE_CHROME_DUST = ITEMS.registerItem("impure_chrome_dust", p -> new TieredItem(p, 9));
    public static final DeferredItem<Item> IMPURE_TITANIUM_DUST = ITEMS.registerItem("impure_titanium_dust", p -> new TieredItem(p, 9));
