...
public class ClayiumBlockEntityTypes {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CentrifugeBlockEntity>> CENTRIFUGE_BLOCK_ENTITY = registerClayContainer(
            "centrifuge_block_entity",
            () -> {
                List<Block> blocks = new ArrayList<>(ClayiumBlocks.CENTRIFUGE_BLOCKS.values().stream()
                        .map(DeferredHolder::get).toList());
                return BlockEntityType.Builder
                        .of(CentrifugeBlockEntity::new, blocks.toArray(Block[]::new))
                        .build(null);
            });

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ChemicalReactorBlockEntity>> CHEMICAL_REACTOR_BLOCK_ENTITY = registerClayContainer(
            "chemical_reactor_block_entity",
            () -> {
                List<Block> blocks = new ArrayList<>(ClayiumBlocks.CHEMICAL_REACTOR_BLOCKS.values().stream()
                        .map(DeferredHolder::get).toList());
                return BlockEntityType.Builder
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ElectrolysisReactorBlockEntity>> ELECTROLYSIS_REACTOR_BLOCK_ENTITY = registerClayContainer(
            "electrolysis_reactor_block_entity",
            () -> {
                List<Block> blocks = new ArrayList<>(ClayiumBlocks.ELECTROLYSIS_REACTOR_BLOCKS.values().stream()
                        .map(DeferredHolder::get).toList());
                return BlockEntityType.Builder
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<ClayReactorBlockEntity>> CLAY_REACTOR_BLOCK_ENTITY = registerClayContainer(
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LaserInterfaceBlockEntity>> LASER_INTERFACE_BLOCK_ENTITY = registerClayContainer(
            "laser_interface_block_entity",
            () -> BlockEntityType.Builder
                    .of(LaserInterfaceBlockEntity::new,
                            ClayiumBlocks.LASER_INTERFACE_BLOCKS.values().stream()
                                    .map(DeferredHolder::get)
                                    .toArray(Block[]::new))
                    .build(null));
